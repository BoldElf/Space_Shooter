        ...
        private void ActionFindNewMovePosition()
        {
            ...
            if (m_AIBehavior == AIBehavior.Patrol)
            {
                if(m_SelectedTarget !=null)
                {
                    ...
                    if(m_Fight == fight.Bots)
                    {
                        m_MovePosition = m_SelectedTarget.transform.position;
                    }
                    if(m_Fight == fight.Player)
                    {
                        MakeLead();
                    }
                }
            ...
            if (m_AIBehavior == AIBehavior.Point)
            {
                m_MovePosition = m_SelectedTargetPoint.transform.position;

                if(m_SpaceShip.transform.position.y >= m_SelectedTargetPoint.transform.position.y)
                {
                    m_MovePosition = m_SelectedTargetPoint_01.transform.position;
                    abc = true;
                }
                if(abc == true && m_SpaceShip.transform.position.x >= m_SelectedTargetPoint_01.transform.position.y)
                {
                    //abc = false;
                    m_MovePosition = m_SelectedTargetPoint_02.transform.position;
                    bce = true;
                }
                if(bce == true && m_SpaceShip.transform.position.y <= m_SelectedTargetPoint_02.transform.position.y)
                {
                    //bce = false;
                    m_MovePosition = m_SelectedTargetPoint_03.transform.position;
                }
            }
        }
